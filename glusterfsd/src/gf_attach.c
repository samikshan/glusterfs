...
send_brick_req (xlator_t *this, struct rpc_clnt *rpc, char *path, int op)
{
        ...
        /* Send the msg */
        ret = rpc_clnt_submit (rpc, &crud_prog, op,
