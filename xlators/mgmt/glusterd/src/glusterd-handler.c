...
static int
__glusterd_handle_get_max_opversion (rpcsvc_request_t *req)
{
        int32_t                         ret = -1;
        gf_cli_req                      cli_req = {{0,},};
        ...
        gf_msg (this->name, GF_LOG_INFO, 0, 0,
                "Received request to get maximum supported op-version");
        ...
        ret = glusterd_op_begin_synctask (req, GD_OP_MAX_OPVERSION, dict);
out:
        if (ret) {
                if (err_str[0] == '\0')
                        snprintf (err_str, sizeof (err_str),
...
int
glusterd_handle_get_max_opversion (rpcsvc_request_t *req)
{
        return glusterd_big_locked_handler (req, __glusterd_handle_get_max_opversion);
}
...
rpcsvc_actor_t gd_svc_cli_actors[GLUSTER_CLI_MAXVALUE] = {
        ...
        [GLUSTER_CLI_MAX_OPVERSION]      = { "MAX_OPVERSION"  ,   GLUSTER_CLI_MAX_OPVERSION,    glusterd_handle_get_max_opversion,     NULL, 0, DRC_NA},
